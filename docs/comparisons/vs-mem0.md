...
Hypabase tracks which session created each memory using provenance context blocks. See the [Agent Memory example](../examples/agent-memory.md) for a complete multi-session walkthrough.
