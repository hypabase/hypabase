...
1. **Recall** what the agent knows about an entity or topic
1. **Consolidate** periodically to merge naming variants and compress episodic clusters
1. **Forget** old or low-strength memories to keep the graph efficient
